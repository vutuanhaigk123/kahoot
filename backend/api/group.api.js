...
router.get("/created-groups", AuthenMw.stopWhenNotLogon, async (req, res) => {
...
router.get("/join", AuthenMw.stopWhenNotLogon, async (req, res) => {
...
router.post("/update-member", AuthenMw.stopWhenNotLogon, async (req, res) => {
...
router.post("/send-invitation", AuthenMw.stopWhenNotLogon, async (req, res) => {
...
router.get("/:groupId", AuthenMw.stopWhenNotLogon, async (req, res) => {
