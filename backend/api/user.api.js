...
router.get("/profile", AuthMW.stopWhenNotLogon, async (req, res) => {
...
router.post("/profile", AuthMW.stopWhenNotLogon, async (req, res) => {
...
router.post("/password", AuthMW.stopWhenNotLogon, async (req, res) => {
